...
//  Copyright (c) 2014年 zby. All rights reserved.
//

#import "CWStarRateView.h"

#define FOREGROUND_STAR_IMAGE_NAME @"starIdentifer_yes"
#define BACKGROUND_STAR_IMAGE_NAME @"starIdentifer_no"
...
- (void)userTapRateView:(UITapGestureRecognizer *)gesture {
    ...
    _starScore = self.allowIncompleteStar ? realStarScore : ceilf(realStarScore);
    
    self.scorePercent = ((float)((int)_starScore))/ self.numberOfStars;
}
...
//    if ([self.delegate respondsToSelector:@selector(starRateView:scroePercentDidChange:)]) {
        [self.delegate starRateView:self scroePercentDidChange:_starScore];
//    }
