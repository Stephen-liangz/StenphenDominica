...
#define FontDetLeSize             15
#define FontDefSize               20
#define StaticItemIndex           4
...
- (void)buttonClick:(UIButton *)button{
    if (!self.isGraduallyChangFont) {
        ...
        _currectItem.titleLabel.font = [UIFont systemFontOfSize:15.f];
        _oldItem = _currectItem;
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"buttonClick" object:[NSNumber numberWithInteger:button.tag]];
